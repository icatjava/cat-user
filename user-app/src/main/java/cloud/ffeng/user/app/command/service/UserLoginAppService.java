...
public interface UserLoginAppService {
     ...
     * @return 登录请求结果信息
     */
    UserLoginFlowDTO loginByPassword(UserLoginByPasswordRequest request);
     ...
     * @return 登录请求结果信息
     */
    UserLoginFlowDTO loginByVerification(UserLoginByVerificationRequest request);
     ...
     * @return 登录请求结果信息
     */
    UserLoginFlowDTO loginByPlatformAuth(UserLoginByPlatformAuthRequest request);
